...
const Home: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] bg-orange-50 px-4 py-16 text-center font-sans font-thin">
      <h1 className="text-5xl font-bold mb-6 max-w-3xl font-serif">You got the travel plans, we got the travel vans.</h1>
